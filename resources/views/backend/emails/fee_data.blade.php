...
<div style="margin-left:auto;margin-right:auto;width:600px;min-height:700px;border:1px solid #eaeaea;text-align: center;border-radius:5px;">
	<div style="background: #ff7b00;height:70px; text-align: center;color:#fff;font-size:25px;padding:0 50px">
		<span style="line-height: 70px;font-weight: 700;">Fee Record</span>
	</div>
	...
	<div style="margin-top:10px;padding:10px;">
		<table border='1' cellpadding="10px" style="text-align:center;margin:0 auto;">
		    ...
		    <tr>
		        <td style="width:200px;text-align:right;">Verify </td><td style="width:200px;text-align:left;"><a href="{{config('app.url')}}verify-fee/{{encrypt($fee->id)}}"><button style="width:100px;height:30px;background:#ff7b00;border:1px solid #ff7b00;border-radius:5px;padding:5px 20px;color:#fff;cursor:pointer;">Verify</button></a></td>
		    </tr>
