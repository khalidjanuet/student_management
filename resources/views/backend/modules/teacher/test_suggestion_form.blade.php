...
<head>
    ...
    <title>Test Result Suggestion Form</title>
    <!-- CSS -->
...
<div class="toast"
    data-title="Success!"
    data-message="Test Result Suggestions Saved Successfully."
    data-type="success">
</div>
@endif
...
<div class="content-banner">
    <div class="container">
        <h1 class="page-title">Test result suggestion form</h1>
            ...
            <div class="row">
                <div class="col-lg-6 mx-md-auto" style="color:#000;">
                    <div class="text-center">
                        ...
                        <h1 class="mt-2" style="color:#000;font-weight:600;">Test result suggestion form</h1>    
                    </div>
                    <form action="{{route('test-suggestion-form-save')}}" method="POST" enctype="multipart/form-data" style="padding:50px;">
                        ...
                        <div class="row" id="students_div">
                            ...
                            <div class="col-md-12" id="test_type_div_1">
                                <div class="form-group">
                                    <div class="label">Test Type:</div>
                                    <select name="test_type_1" id="test_type_1" class="form-control">
                                       <option value="0">Choose Test Type</option>
                            ...
                            <div class="col-md-12" id="test_suggestion_div_1">
                                <div class="form-group">
                                    <div class="label">Suggestion:</div>
                                    <textarea name="suggestion_1" id="suggestion_1" class="form-control" rows="5"></textarea>
...
<script>
     function add_student(count)
    {
        ...
        $('#students').val(count);
        $('#students_div').append(`
            <div class="col-md-12" id="test_type_div_`+count+`">
                <div class="form-group">
                    <div class="label">Test Type:</div>
                    <select name="test_type_`+count+`" id="test_type_`+count+`" class="form-control">
                        <option value="0">Choose Test Type</option>
                        <option value="1">Practice</option>
                        <option value="2">Mock</option>
                    </select>
            ...
            <div class="col-md-12" id="student_div_`+count+`">
                <div class="form-group">
                    ...
                    <select name="student_id_`+count+`" id="student_id_`+count+`" class="form-control select2">
                        <option value="0">Choose Student</option>
                        @foreach($students as $student)
                            <option value="{{$student->id}}">ID: {{$student->roll_no}} | {{$student->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-12" id="test_suggestion_div_`+count+`">
                <div class="form-group">
                    <div class="label">Suggestion:</div>
                    <textarea name="suggestion_`+count+`" id="suggestion_`+count+`" class="form-control" rows="5"></textarea>
    ...
    function remove_student(count)
    {
        ...
        $('#test_suggestion_div_'+count).remove();
    }
</script>
</body>
</html>