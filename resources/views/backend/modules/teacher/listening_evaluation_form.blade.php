...
<head>
    ...
    <title>Listening Evaluation Form</title>
    <!-- CSS -->
...
<div class="content-banner">
    <div class="container">
        <h1 class="page-title">Listening Evaluation</h1>
            ...
            <div class="row">
                <div class="col-lg-12 mx-md-auto" style="color:#000;">
                    <div class="text-center">
                        ...
                        <h1 class="mt-2" style="color:#000;font-weight:600;">IELTS MASTER LISTENING EVALUATION FORM</h1>    
                    </div>
                    <form action="{{route('listening-evaluation-save')}}" method="POST" enctype="multipart/form-data" style="padding:50px;">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Listening Practice Number:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select class="form-control select2" name="session" required id="session" >
                                        <option value="" disabled>Select Practice Number</option>
    ...
    function change_student_id()
    {
        ...
        $('#student_id').val(student);
         $.ajax({
                ...
                data:{'student_id':student,'type':1,'test_type': $('#test_type').val()},
