...
<head>
    ...
    <title>Speaking Evaluation Form</title>
    <!-- CSS -->
...
<div class="content-banner">
    <div class="container">
        <h1 class="page-title">Speaking Evaluation</h1>
            ...
            <div class="row">
                <div class="col-lg-12 mx-md-auto" style="color:#000;">
                    <div class="text-center">
                        ...
                        <h1 class="mt-2" style="color:#000;font-weight:600;">IELTS MASTER SPEAKING EVALUATION FORM</h1>    
                    </div>
                    <form action="{{route('speaking-evaluation-save')}}" method="POST" enctype="multipart/form-data" style="padding:50px;">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Student ID / Roll No:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Speaking Practice Number:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Problems:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <textarea class="form-control" name="problems" id="" cols="30" rows="5" required>{{old('problems')}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Fluency & Cohesion:<span style="color:red">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    
                                    <select name="fluency_cohesion" id="" class="form-control" required>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Pronunciation:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    
                                    <select name="pronunciation" id="" class="form-control" required>
                                    <option value="0">Absent</option>
                                        <option value="3">Band 3</option>
                                        <option value="3.5">Band 3.5</option>
                                        <option value="4">Band 4</option>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5>Tutor Name:<span style="color:red;">*</span></h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
<script>
    function change_student_id()
    {
        ...
        $.ajax({
                ...
                data:{'student_id':student,'type':3,'test_type': $('#test_type').val()},
