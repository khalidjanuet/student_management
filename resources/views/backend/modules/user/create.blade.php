            ...
            <div class="row">
                <div class="col-lg-12 mx-md-auto" style="color:#000;">
                    ...
                    <div class="text-center">
                        ...
                        <h1 class="mt-2" style="color:#000;font-weight:600;">User Registration Form</h1>   
                    </div>
                    <form action="{{route('user-save')}}" method="POST" enctype="multipart/form-data" style="padding:50px;">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name" id="" placeholder="Name" required value="{{old('name')}}"> 
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-4">
                               <div class="form-group">
                                   <input type="password" class="form-control" name="confirm_password" id="confirm_password" onblur="check_password()" value="{{old('confirm_password')}}" required>
                       ...
                       <div class="row">
                        ...
                        <div class="row" id="module_div" style="display:none;">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                {{csrf_field()}}
                                <input type="submit" class="btn btn-success btn-lg btn-block" disabled="true" id="submit_button" value="Submit Form" style="background:#ff7b00;width:300px;margin:10px auto;">
                            </div>
                        </div>
