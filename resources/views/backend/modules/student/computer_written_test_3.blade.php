...
<style>
    ...
    .main-content-container {
        border-top: 1px solid transparent;
        background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAyCAYAAAB70nrOAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAENJREFUeNpiZGBgMGdAAixA/J90gX9U0PKPCloGrQA1vE+NUKe9ADMQMyILMDGgAeJUMOBVgSFAH8D4//9//O4ACDAAvp8loaZ6QxkAAAAASUVORK5CYII=);
        background-repeat: repeat-x;
        min-height: 500px;
    }
    .banner.black+.main-content-container {
...
<body class="light" >
    ...
    <div id="app">
        ...
        <form id="test_form" action="{{route('student-writing-test-submit')}}" method="post">
            ...
            <input type="hidden" name="question_1" value="{{$questions[0]->id}}">
            <input type="hidden" name="question_2" value="{{$questions[1]->id}}">
            <input type="hidden" name="type" value="{{$type}}">
            
            
            <div class="main-content-container full-height">
                ...
                <div class="test-container" id="task1">
                        ...
                        <div class="title">
                            <h4 style="font-weight:700;color:#000;">Academic Writing Part 1</h4>
                            <p style="margin:0;"><b>You should spend about 20 minutes on this task. Write at least 150 words.</b></p>
                        </div>
            ...
            <div class="test-container" id="task2" style="height:0;">
                    
                        <div class="title">
                            <h4 style="font-weight:700;color:#000;">Academic Writing Part 2</h4>
                            <p style="margin:0;"><b>You should spend about 20 minutes on this task. Write at least 150 words.</b></p>
                        </div>
                        ...
                        <div class="answer">
                            <div>
                                <div class="text-area-container">
                                    <textarea spellcheck="false" name="task2_answer" id="task2_textarea" onkeyup="wordCounter2()"></textarea>
                                    <p>Word Count: <span id="count2">0</span></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="question-nav ">
                    <ul>
                        ...
                        <li class="">
                            ...
                            <div class="hover-message">Question 2</div>
                            <span class="arrow-down"></span>
                        </li>
                    </ul>
    ...
    <div class="main-content-container" id="confirm_container" style="display:none;">
        <div class="confirm-finish-container">
            ...
            <div>
                ...
                <button style="cursor:pointer;" onclick="review_answers();">Review answers</button>
            </div>
        </div>
    </div>
<!--/#app -->
...
function next()
{
    ...
    if(wordCount < 150 )
    {
        alert('Words should be atleast 150');
        return;
    }
    if(active == 1)
    {
        $('#task1').css('display','none');
        $('#task2').addClass('task2-active');
    ...
    {
        $('#task1').css('display','none');
        $('#task2').removeClass('task2-active');
