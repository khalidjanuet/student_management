            ...
            <div class="d-flex justify-content-left">
                <div class="align-self-end" style="height:50px;">
                    <ul class="nav nav-material nav-material-white card-header-tabs" role="tablist">
                        ...
                        <li class="nav-item blue" style="margin-top:0;width:250px;">
                            <a class="nav-link" style="" id="w6--tab2" data-toggle="tab" href="#w6-tab2" role="tab" aria-controls="tab2" aria-expanded="true" aria-selected="true">Purchase Course</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade" id="w6-tab2" role="tabpanel" aria-labelledby="w6-tab2">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin-top:10px;">
                            <div class="card">
                                <div class="card-header white">
                                    <strong> Courses Information</strong>
                                </div>
                                <div class="card-body"  style="overflow-x:scroll;padding:100px 50px;">
                                    <label for="courses"> Select Your Desired Courses:</label>
                                    ...
                                    <button class="btn btn-success" style="margin-top:30px;">Purchase Course(s)</button>
                                </div>
                            </div>
                        </div>
